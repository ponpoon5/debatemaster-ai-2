  ...
  switch (framework) {
    ...
    case ThinkingFramework.FIVE_WHYS:
      ...
      scoringCriteria = `
            [採点基準 (100点満点)]
            1. 問題定義の明確さ (30点):
               - Problem（問題文）が明確か (10点)
               - Impact/Scope/Timeframe/Evidence が適切に示されているか (20点)
            2. 因果の論理性 (40点): 「AだからB」という繋がりが強固か。
            3. 深掘りの度合い (15点): 5段階まで深く掘り下げられているか。
            4. 真因への到達度 (15点): 解決可能な根本原因に辿り着いたか。`;
      break;
